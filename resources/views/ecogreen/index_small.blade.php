    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 menu-column">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="btn btn-sm btn-outline-primary">{{ __('Log In') }}</button>
                            </form>
                            @endif
    ...
    <div id="slider1" class="rev_slider"  data-version="5.0">
        <ul>
            ...
            <li data-transition="fade">
                <img src="{{asset('_ecogreen/images/slider/1.jpg')}}"  alt="" width="1920" height="888" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <li data-transition="fade">
                <img src="{{asset('_ecogreen/images/slider/2.jpg')}}"  alt="" width="1920" height="580" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <li data-transition="fade">
                <img src="{{asset('_ecogreen/images/slider/3.jpg')}}"  alt="" width="1920" height="888" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
...
<section class="fact-counter style-2 sec-padd" style="background-image: url({{asset('_ecogreen/images/background/5.jpg')}});">
    <div class="container">
        <div class="section-title center">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <figure class="img-box">
                    <img src="{{asset('_ecogreen/images/resource/8.jpg')}}" alt="">
                </figure>
            </div>
...
<section class="gallery sec-padd3 style-2" style="background-image: url({{asset('_ecogreen/images/background/8.jpg')}})";>
    <div class="container">
        ...
        <div class="row filter-layout">
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 filter-item Wild-Animals Pollution Water">
                <div class="item">
                    <div class="img-box">
                        <img src="{{asset('_ecogreen/images/project/1.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="inner-box">
                                <div class="content-box">
                                    <a data-group="1" href="{{asset('_ecogreen/images/project/1.jpg')}}" class="img-popup"><i class="fa fa-search-plus"></i></a>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 filter-item Wild-Animals Pollution Ecology Recycling">
                <div class="item">
                    <div class="img-box">
                        <img src="{{asset('_ecogreen/images/project/2.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="inner-box">
                                <div class="content-box">
                                    <a data-group="1" href="{{asset('_ecogreenimages/project/2.jpg')}}" class="img-popup"><i class="fa fa-search-plus"></i></a>
                                    <a href="single-gallery.html"><i class="fa fa-link"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 filter-item Wild-Animals Pollution Ecology Recycling">
                <div class="item">
                    <div class="img-box">
                        <img src="{{asset('_ecogreen/images/project/3.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="inner-box">
                                <div class="content-box">
                                    <a data-group="1" href="{{asset('_ecogreen/images/project/3.jpg')}}" class="img-popup"><i class="fa fa-search-plus"></i></a>
                                    <a href="single-gallery.html"><i class="fa fa-link"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 filter-item Wild-Animals Pollution Water">
                <div class="item">
                    <div class="img-box">
                        <img src="{{asset('_ecogreen/images/project/4.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="inner-box">
                                <div class="content-box">
                                    <a data-group="1" href="{{asset('_ecogreen/images/project/4.jpg')}}" class="img-popup"><i class="fa fa-search-plus"></i></a>
                                    <a href="single-gallery.html"><i class="fa fa-link"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="cause-carousel">
            <div class="item clearfix">
                <figure class="img-box">
                    <img src="{{asset('_ecogreen/images/resource/9.jpg')}}" alt="">
                    <div class="overlay">
                        <div class="inner-box">
                            <div class="content-box">
            ...
            <div class="item clearfix">
                <figure class="img-box">
                    <img src="{{asset('_ecogreen/images/resource/10.jpg')}}" alt="">
            ...
            <div class="item clearfix">
                <figure class="img-box">
                    <img src="{{asset('_ecogreen/images/resource/11.jpg')}}" alt="">
                    <div class="overlay"><div class="inner-box"><div class="content-box"><button class="thm-btn style-2 donate-box-btn">donate now</button></div></div></div>
                </figure>
...
<section class="event-style1" style="background-image: url({{asset('_ecogreen/images/background/3.jpg')}})";>
    <div class="container">
        <div class="row">
                ...
                <div class="item style-1">
                    <div class="img-column">
                        <figure class="img-holder">
                            <a href="single-event.html"><img src="{{asset('_ecogreen/images/resource/1.jpg')}}" alt=""></a>
            ...
            <article class="col-md-6 col-sm-12 col-xs-12">
                <div class="item style-2">
                    <div class="clearfix">
                        <div class="img-column">
                            <figure class="img-holder">
                                <a href="single-event.html"><img src="{{asset('_ecogreen/images/resource/2.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="text-column">
                            <div class="lower-content">
                ...
                <div class="item style-2">
                    <div class="clearfix">
                        <div class="img-column">
                            <figure class="img-holder">
                                <a href="single-event.html"><img src="{{asset('_ecogreen/images/resource/3.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="text-column">
                            <div class="lower-content">
        ...
        <div class="row">
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated animated" style="visibility: visible; animation-name: fadeInUp;">
                    <figure class="img-holder">
                        <a href="blog-details.html"><img src="{{asset('_ecogreen/images/blog/1.jpg')}}" alt="News"></a>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated animated" style="visibility: visible; animation-name: fadeInUp;">
                    <figure class="img-holder">
                        <a href="blog-details.html"><img src="{{asset('_ecogreen/images/blog/2.jpg')}}" alt="News"></a>
                        <figcaption class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i></a>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated animated" style="visibility: visible; animation-name: fadeInUp;">
                    <figure class="img-holder">
                        <a href="blog-details.html"><img src="{{asset('_ecogreen/images/blog/3.jpg')}}" alt="News"></a>
                        <figcaption class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i></a>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated animated" style="visibility: visible; animation-name: fadeInUp;">
                    <figure class="img-holder">
                        <a href="blog-details.html"><img src="{{asset('_ecogreen/images/blog/4.jpg')}}" alt="News"></a>
                        <figcaption class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i></a>
    ...
    <div class="container">
        ...
        <div class="client-carousel owl-carousel owl-theme">
            ...
            <div class="item tool_tip" title="media partner">
                <img src="{{asset('_ecogreen/images/clients/1.jpg')}}" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="media partner">
                <img src="{{asset('_ecogreen/images/clients/2.jpg')}}" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="media partner">
                <img src="{{asset('_ecogreen/images/clients/3.jpg')}}" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="media partner">
                <img src="{{asset('_ecogreen/images/clients/4.jpg')}}" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="media partner">
                <img src="{{asset('_ecogreen/images/clients/5.jpg')}}" alt="Awesome Image">
            </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="footer-widget about-column">
                                <figure class="footer-logo"><a href="index.html"><img src="{{asset('_ecogreen/images/logo/logo2.png')}}" alt=""></a></figure>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget post-column">
                                ...
                                <div class="post-list">
                                    <div class="post">
                                        <div class="post-thumb"><a href="#"><img src="{{asset('_ecogreen/images/blog/thumb1.jpg')}}" alt=""></a></div>
                                        <a href="#"><h5>Marathon 2017: <br>Run for Cancer People</h5></a>
                                        <div class="post-info"><i class="fa fa-calendar"></i>  15 Mar, 2017</div>
                                    </div>
                                    <div class="post">
                                        <div class="post-thumb"><a href="#"><img src="{{asset('_ecogreen/images/blog/thumb2.jpg')}}" alt=""></a></div>
