    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 body-main">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4"> <img class="img" alt="Invoce Template" src="pictures/logo_large.png" width="150" height="90"/> </div>
                        <div class="col-md-8 text-right">
                            <h4 style="color: #F81D2D;"><strong>test</strong></h4>
                            <p>221 ,Baker test Street:  {{$booking}} </p>
                            <p>1800-234-124</p>
